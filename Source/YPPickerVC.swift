...
open class YPPickerVC: YPBottomPager, YPBottomPagerDelegate {
    ...
    func updateUI() {
        if !YPConfig.hidesCancelButton {
            ...
            navigationItem.leftBarButtonItem?.tintColor = YPConfig.colors.navigationBarCancelColor
        }
        switch mode {
        case .library:
            ...
            navigationItem.rightBarButtonItem?.tintColor = YPConfig.colors.navigationBarNextColor
